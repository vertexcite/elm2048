...
Elm.Game2048.make = function (_elm) {
   ...
   var buttonSize = 300;
   var txt = F3(function (p,
   clr,
   string) {
      return $Graphics$Element.leftAligned($Text.height(p * buttonSize)($Text.typeface(_L.fromArray(["Helvetica Neue"
                                                                                                    ,"Sans-serif"]))($Text.color(clr)($Text.fromString(string)))));
   });
   var commands = $Signal.mailbox({ctor: "_Tuple0"});
   var button = F5(function (background,
   foreground,
   w,
   h,
   name) {
      return function () {
         var n = A2($Basics.min,w,h);
         var btn = function (alpha) {
            return $Graphics$Element.layers(_L.fromArray([$Graphics$Element.color($Color.black)(A3($Graphics$Element.container,
                                                         w,
                                                         h,
                                                         $Graphics$Element.bottomRight)($Graphics$Element.color(background)(A3($Graphics$Element.container,
                                                         w - 1,
                                                         h - 1,
                                                         $Graphics$Element.midLeft)(A4($Graphics$Element.container,
                                                         n,
                                                         n,
   ...
   var simpleButton = function (name) {
      return A5(button,
      $Color.grey,
      $Color.black,
      buttonSize,
      ...
      return function () {
         ...
         {case "_Tuple2":
            return A2($Graphics$Collage.collage,
              ...
              _v0._1);}
         _U.badCase($moduleName,
         "on line 351, column 26 to 45");
      }();
   },
   $Window.dimensions);
   var seed = Elm.Native.Port.make(_elm).inbound("seed",
   "Int",
   function (v) {
      return typeof v === "number" ? v : _U.badPort("a number",
      v);
   });
   var ButtonAction = function (a) {
      return {ctor: "ButtonAction"
             ,_0: a};
   };
   var Move = function (a) {
   ...
   $Keyboard.arrows),
   $Touch$Gestures.ray);
   var inputSignal = A2($Signal.merge,
   A2($Signal._op["<~"],
   Move,
   arrows),
   A2($Signal._op["<~"],
   ...
   var move = function (sq) {
      return _U.replace([["y"
                         ,sq.y + 1]],
      sq);
   };
   var up = $Basics.identity;
   var transpose = function (sq) {
      return _U.replace([["y",sq.x]
                        ,["x",sq.y]],
      sq);
   };
   var right = transpose;
   ...
   var mergeSquare = F2(function (sq,
   grid) {
      return function () {
   ...
   var mergeGrid = A2(applyInOrder,
   mergeSquare,
   $List.sortBy(function (sq) {
      return 0 - sq.y;
   }));
   ...
   g2) {
      ...
      $List.length(g2)) ? false : function () {
         var hasMatchingSquareInGrid1 = function (s2) {
            return function () {
               var _v25 = A2(squareAt,
               g1,
               squareCoord(s2));
               switch (_v25.ctor)
               {case "Just":
                  return _U.eq(_v25._0.contents,
                    s2.contents);
                  case "Nothing": return false;}
               _U.badCase($moduleName,
   ...
   var drawSquare = function (square) {
      return function () {
         var numElem = $Graphics$Collage.scale(scaleForNumber(square.contents))($Graphics$Collage.toForm($Graphics$Element.show(square.contents)));
   ...
   var dim = 4;
   var flipy = function (sq) {
      return _U.replace([["y"
                         ,dim - sq.y + 1]],
      sq);
   };
   var down = flipy;
   var left = function (sq) {
      return _U.replace([["y"
                         ,dim - sq.x + 1]
                        ,["x",dim - sq.y + 1]],
      sq);
   ...
   var atEdge = function (sq) {
      return _U.eq(sq.y,dim);
   };
   var shiftSquare = F2(function (sq,
   grid) {
      return atEdge(sq) ? A2($List._op["::"],
      sq,
      grid) : function () {
         var _v29 = A2(squareAt,
         grid,
         squareCoord(move(sq)));
         switch (_v29.ctor)
         {case "Nothing":
   ...
   var shift = function (grid) {
      return function () {
         var shiftFold = function ($) {
            ...
            shiftSquare,
            _L.fromArray([]))($List.sortBy(function (sq) {
               return sq.y;
            })($));
         };
         return A3(apply,
   ...
   grid) {
      return $List.map(dir)(shift(mergeGrid(shift(A2($List.map,
      dir,
      grid)))));
   });
   ...
   var coreUpdate = F2(function (mdir,
   _v36) {
      return function () {
         switch (_v36.ctor)
         {case "_Tuple4":
            return function () {
                 ...
                 {case "Just":
                    return function () {
                         ...
                         return A2(sameGrid,
                         penUpdatedGrid,
                         _v36._1) ? _v36 : has2048(penUpdatedGrid) && $Basics.not(has2048(_v36._1)) ? {ctor: "_Tuple4"
                                                                                                      ,_0: GameWon
                                                                                                      ,_1: penUpdatedGrid
                                                                                                      ,_2: A2($List._op["::"],
                                                                                                      _v36._1,
                            ...
                            return function () {
                               ...
                               {case "Just":
                                  return function () {
                                       var updatedGrid = A2($List._op["::"],
                                       _v44._0,
                                       penUpdatedGrid);
                                       return canMove(updatedGrid) ? {ctor: "_Tuple4"
                                                                     ,_0: Playing
                                                                     ,_1: updatedGrid
                                                                     ,_2: A2($List._op["::"],
                                                                     _v36._1,
                                                                     _v36._2)
                                                                     ,_3: seed$} : {ctor: "_Tuple4"
                                                                                   ,_0: GameLost
                                                                                   ,_1: updatedGrid
                                                                                   ,_2: A2($List._op["::"],
                                                                                   _v36._1,
                                  ...
                                  case "Nothing":
                                  return canMove(_v36._1) ? _v36 : {ctor: "_Tuple4"
                                                                   ,_0: GameLost
                                                                   ,_1: penUpdatedGrid
                                                                   ,_2: A2($List._op["::"],
                                                                   _v36._1,
                 ...
                 _U.badCase($moduleName,
                 "between lines 210 and 223");
              }();}
         _U.badCase($moduleName,
         "between lines 210 and 223");
      }();
   });
   var startGrid = function (seed) {
      return function () {
               ...
               switch (_v51._0.ctor)
                 {case "Just":
                    return function () {
                         switch (m2.ctor)
                         {case "Just":
                            return _L.fromArray([_v51._0._0
                                                ,m2._0]);}
                         return _L.fromArray([_v51._0._0]);
                      }();
                    case "Nothing":
                 ...
                 break;}
            _U.badCase($moduleName,
            "between lines 257 and 262");
         }();
      }();
   };
   var startState = function (seed) {
      return {ctor: "_Tuple4"
             ,_0: Playing
             ,_1: startGrid(seed)
             ,_2: _L.fromArray([])
                 ...
                 {case "ButtonAction":
                    return function () {
                         ...
                         {case "::":
                            ...
                            case "[]": return _v57;}
                         _U.badCase($moduleName,
                         "between lines 323 and 325");
                      }();
                    case "Move":
                    switch (input._0.ctor)
                      {case "Nowhere": return _v57;}
                      return A2(coreUpdate,
                      direction(input._0),
                      _v57);}
                 _U.badCase($moduleName,
   ...
   updateGameState,
   startState($Random.initialSeed(seed)),
   inputSignal);
   ...
   grid) {
      return function () {
         ...
         $Color.grey,
         $Graphics$Element.centered($Text.fromString(message))))));
         return $Graphics$Collage.group(_L.fromArray([drawGrid(grid)
                                                     ,messageForm]));
      }();
   });
   var drawGame = function (_v69) {
      return function () {
         switch (_v69.ctor)
         {case "_Tuple4":
            return function () {
   ...
   var makeTform = function (_v76) {
      return function () {
         switch (_v76.ctor)
         {case "_Tuple2":
            return A2($Transform2D.multiply,
              A2($Transform2D.translation,
              $Basics.toFloat(_v76._0) / (0 - $Basics.toFloat(dim)),
              $Basics.toFloat(_v76._1) / (0 - $Basics.toFloat(dim))),
              $Transform2D.scale(A2(scaleFor,
              _v76._0,
              _v76._1)));}
         _U.badCase($moduleName,
         "on line 339, column 19 to 132");
      }();
   };
   ...
   $Graphics$Element.above(simpleButton("Undo")),
   main1);
      ...
      return function () {
         ...
         {case "Swipe":
            return A2($List.map,
              ...
              A2($List.filter,
              function (x) {
                 return _U.cmp(A2($Basics.uncurry,
                 $Touch$Util.distance,
                 x),
                 50) > 0;
              },
...
Elm.Touch.Gestures.make = function (_elm) {
   ...
   function ($) {
      return $Maybe.withDefault($Touch$Cardinal.Nowhere)($List.head(f($)));
   },
   touchDragState);
   ...
   var slide = function () {
      var ok = function (ts) {
         ...
         function ($) {
            return $Basics.not($Touch$Util.isTap($));
         },
         ts)));
      };
      return A2($Signal._op["<~"],
...
Elm.Touch.Signal.Derived.make = function (_elm) {
   ...
   s) {
      return function () {
         ...
         return A2($Signal._op["<~"],
         function ($) {
            return $Maybe.withDefault(dflt)($Basics.snd($));
         },
         A3($Signal.filter,
         switched,
         zero,
   ...
   var collectN = function (n) {
      return A2($Signal.foldp,
      F2(function (x,acc) {
         return $List.take(n)(A2($List._op["::"],
         x,
         acc));
      }),
      _L.fromArray([]));
            ...
            return function () {
                 ...
                 {case "_Tuple2":
                    return function () {
                         ...
                         return $Basics.round($Basics.sqrt($Basics.toFloat(Math.pow(a,
                         2) + Math.pow(b,2))));
                      }();}
                 _U.badCase($moduleName,
